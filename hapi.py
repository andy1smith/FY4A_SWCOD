...
PARAMETER_META = {
    ...
    "gamma_HT_0_air_50": {"default_fmt": "%6.4f"},
    "n_HT_air_50": {"default_fmt": "%9.6f"},
    "gamma_HT_2_air_50": {"default_fmt": "%6.4f"},
    "delta_HT_0_air_50": {"default_fmt": "%9.6f"},
    "deltap_HT_air_50": {"default_fmt": "%9.6f"},
    "delta_HT_2_air_50": {"default_fmt": "%9.6f"},
    "gamma_HT_0_air_150": {"default_fmt": "%6.4f"},
    "n_HT_air_150": {"default_fmt": "%9.6f"},
    ...
    "gamma_HT_0_air_296": {"default_fmt": "%6.4f"},
    "n_HT_air_296": {"default_fmt": "%9.6f"},
    ...
    "gamma_HT_0_air_700": {"default_fmt": "%6.4f"},
    "n_HT_air_700": {"default_fmt": "%9.6f"},
    "gamma_HT_2_air_700": {"default_fmt": "%6.4f"},
    "delta_HT_0_air_700": {"default_fmt": "%9.6f"},
    "deltap_HT_air_700": {"default_fmt": "%9.6f"},
    "delta_HT_2_air_700": {"default_fmt": "%9.6f"},
    "nu_HT_air": {"default_fmt": "%6.4f"},
    "kappa_HT_air": {"default_fmt": "%9.6f"},
    "eta_HT_air": {"default_fmt": "%9.6f"},
}
...
def absorptionCoefficient_HT(
    ...
    Components, SourceTables, Environment, OmegaRange, OmegaStep, OmegaWing, IntensityThreshold, Format = getDefaultValuesForXsect(
        Components,
        SourceTables,
        Environment,
        OmegaRange,
...
def abscoef_Voigt(
    table=None, step=None, grid=None, env={"T": 296., "p": 1.}, file=None
):
...
def convolveSpectrumFull(
    Omega, CrossSection, Resolution=0.1, AF_wing=10., SlitFunction=SLIT_RECTANGULAR
):
    """
    Convolves cross section with a slit function with given parameters.
    """
