"""
Train cloudy dMf re=5 downwelling surrogates for GHI and DNI.
...
DEFAULT_CSV = SCRIPT_DIR / "cloudy_dw_dMf_re5_LUT.csv"
RANDOM_STATE = 42
...
HGB_MODEL_NAME = "SWRTM_cloudy_dw_dMf_re5_GHI_DNI_PC1_HGB_V1.pkl"
INTERP_MODEL_NAME = "SWRTM_cloudy_dw_dMf_re5_GHI_DNI_PC1_interp_V1.pkl"
DEFAULT_MODEL_ALIAS = "model.pkl"
DEFAULT_OUTPUT_TAG = "cloudy_dw_dMf_re5"
DEFAULT_MODEL_PREFIX = "SWRTM_cloudy_dw_dMf_re5_GHI_DNI_PC1"
DEFAULT_TITLE = "Cloudy DW dMf re=5"
DEFAULT_DESCRIPTION = "Cloudy dMf re=5 DW surrogate"
...
def build_interpolator_bundle(df: pd.DataFrame, albedo_transform: dict) -> dict:
    ...
    return {
        ...
        "metadata": {
            "description": "Cloudy dMf re=5 DW surrogate using regular-grid interpolation.",
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Train cloudy dMf re=5 DW GHI/DNI surrogates.")
