"""
Train cloudy dMf re=5 FY4A AGRI-channel surrogate V1.
...
DEFAULT_CSV = SCRIPT_DIR / "preprocessed_cloudy_uw_dM_f_escape_re5.csv"
CHANNELS = ["C01", "C02", "C03", "C05", "C06"]
BASE_FEATURES = ["log1p_COD", "tpw", "cos_th0"]
MODEL_NAME = "SWRTM_cloudy_uw_channel_dMf_re5_V1.pkl"
INTERP_MODEL_NAME = "SWRTM_cloudy_uw_channel_dMf_re5_interp_V1.pkl"
OUTPUT_TAG = "channel_dMf_re5"
TITLE = "Cloudy dMf re=5"
RANDOM_STATE = 42
...
def build_interpolator_bundle(df: pd.DataFrame) -> dict:
    ...
    return {
        ...
        "metadata": {
            "description": "Cloudy dMf re=5 forward surrogate: regular-grid interpolation of the RTM LUT",
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Train cloudy dMf re=5 independent FY4A AGRI-channel surrogates V1.")
    ...
    bundle = {
        ...
        "target_columns": CHANNELS,
        "metadata": {
            "description": "Cloudy dMf re=5 forward surrogate: independent channel models using log1p(COD), TPW, cos(th0), and same-channel albedo",
