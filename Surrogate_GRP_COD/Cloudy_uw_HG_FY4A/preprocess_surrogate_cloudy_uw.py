"""
Preprocess cloudy FY4A AGRI upwelling LUT outputs for COD surrogate training.
...
Run on the server from the repository root, for example:
    ...
    python Surrogate_GRP_COD/Cloudy_uw_HG_FY4A/preprocess_surrogate_cloudy_uw.py \
        --dir /path/to/LUTcases/HG/fy4a_channels \
        --out Surrogate_GRP_COD/Cloudy_uw_HG_FY4A/preprocessed_cloudy_uw_HG.csv
"""
...
def default_data_dir() -> str:
    ...
    defaults = {
        "user-Super-Server": "/home/dengnan/data/RTM/LUTcases/HG/fy4a_channels/",
        "user-MS-7D30": "/mnt/dengnan/LUTcases/HG/fy4a_channels/",
        "h07mgt1": "/puhome/22117689r/projects/FY4A_SWCOD/LUTcases/HG/fy4a_channels/",
        "dengnans-MacBook-Pro.local": str(REPO_ROOT / "RTM/LUTcases/HG/fy4a_channels/"),
    }
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Preprocess cloudy HG FY4A upwelling RTM outputs.")
    parser.add_argument("--dir", default=default_data_dir(), help="Directory containing Results_*.npy files.")
    parser.add_argument(
        "--out",
        default=str(SCRIPT_DIR / "preprocessed_cloudy_uw_HG.csv"),
